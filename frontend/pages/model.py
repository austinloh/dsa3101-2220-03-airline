...
layout = html.Div(
    children=[
        ...
        html.H5(
            " We looked at data from over a million flights and built a simple model from it, so YOU don't have to. Among the top factors that determine if a flight will be delayed, we handpicked these 3 for YOU to customize. Try our tool to take a look at how these 3 factors affect a flight's delay:"
        ),
        html.Br(),
        html.Br(),
        dbc.Row(
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        html.H6(
                            "Scheduled Departure Hour:", style={"textAlign": "center"}
                        ),
                        dcc.Slider(
                            id="CRSDepTime",
                            min=0,
        ...
        html.Br(),
        html.H6(
            [("Data taken from: "), html.Em("2006 - 2008")],
